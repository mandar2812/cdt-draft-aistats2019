...
1. Scatter plots of velocity vs time lag, this helps us compare the v-timelag relationship, the red points represent model predictions and black dots represent ground truth data points in the test set.

2. Scatter plots of prediction error in velocity vs prediction error in time lag.
...
\vspace{.3in}
\caption{\textbf{Exp 2}: Output-Time Lag Scatter plot on test data; model predictions in red and actual data in black}
\end{figure}
...
\vspace{.3in}
\caption{\textbf{Exp 2}: Error Scatter plot on test data}
\end{figure}
...
\vspace{.3in}
\caption{\textbf{Exp 3}: Output-Time Lag Scatter plot; model predictions in red and actual data in black}
\end{figure}
...
\vspace{.3in}
\caption{\textbf{Exp 3}: Error Scatter plot on test data}
\end{figure}
...
\vspace{.3in}
\caption{\textbf{Exp 4}: Output-Time Lag Scatter plot; model predictions in red and actual data in black}
\end{figure}
